...
Python enrichment and query server for Hippo. Polls the shared SQLite database for new shell events, enriches them via local LLMs (LM Studio), and serves semantic search queries over HTTP.
