...
2. `precmd` fires after the command completes — computes duration, captures exit code and git state, then sends the
   event to the daemon via `hippo send-event shell`
