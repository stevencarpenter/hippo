...
Shared Rust library for the Hippo system. Provides types, configuration loading, SQLite storage, secret redaction, and the protocol definition used between the shell hook and daemon.
