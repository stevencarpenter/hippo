...
-- Claude Code auto-memory is a read-only source. Documents provide stable
-- identity, revisions retain bounded source history, and chunks are the unit
-- linked to knowledge nodes and embeddings.
